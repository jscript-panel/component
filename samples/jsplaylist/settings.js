...
function oCheckBox(id, x, y, label, linkedVariable, parentPageId) {
	...
	this.setButtons = function () {
		...
		gb.WriteText(chars.check_off, g_font_fluent_40.str, p.settings.color1, 0, 0, 48, 48, 2, 2);
		...
		gb.WriteText(chars.check_on, g_font_fluent_40.str, p.settings.color2, 0, 0, 48, 48, 2, 2);
	...
	this.draw = function (gr) {
		...
		if (this.ly > cSettings.topBarHeight) {
			...
			gr.WriteText(this.label, g_font_12_bold.str, (this.status ? p.settings.color2 : p.settings.color1), label_x, this.ly, p.settings.w, p.settings.txtHeight + 10, 0, 2, 1);
		}
	}
...
function oRadioButton(id, x, y, label, status, parentPageId) {
	...
	this.setButtons = function () {
		...
		gb.WriteText(chars.radio_off, g_font_fluent_40.str, p.settings.color1, 0, 0, 48, 48, 2, 2);
		...
		gb.WriteText(chars.radio_on, g_font_fluent_40.str, p.settings.color2, 0, 0, 48, 48, 2, 2);;
...
function oTextBox(id, x, y, w, h, label, value, parentPageId) {
	...
	this.draw = function (gr) {
		...
		if (this.ly + this.h > cSettings.topBarHeight) {
			gr.WriteText(this.label, g_font_12_bold.str, p.settings.color1, this.x, this.ly, p.list.w - p.settings.pages[this.parentPageId].scrollbarWidth - 10, this.h, 0, 2, 1);
...
function oListBox(id, objectName, x, y, w, h, row_height, label, arr, selectedId, parentPageId) {
	...
	this.draw = function (gr) {
		...
		if (this.label.length > 0) {
			gr.WriteText(this.label, g_font_12_bold.str, p.settings.color1, this.x, this.ly - this.rowHeight - g_z2, this.w, this.rowHeight, 0, 2, 1);
		}
		...
		for (var i = this.offset; i < this.max + this.offset; i++) {
			...
			gr.WriteText((isCustom ? "[" : "") + this.arr[i] + (isCustom ? "]" : ""), i == this.selectedId ? g_font_12_bold.str : g_font_12.str, (i == this.selectedId ? RGB(0, 0, 0) : RGB(0, 0, 0)), this.x + g_z5, this.ly + row * this.rowHeight, this.w - this.scrollbarWidth - g_z10, this.rowHeight, 0, 2, 1);
			row++;
		}
	}
...
function oPage(id, objectName, label, nbrows) {
	...
	this.draw = function (gr) {
		...
		switch (this.id) {
		case 0:
			gr.WriteText("Layout", g_font_12_bold.str, p.settings.color1, txtbox_x, cSettings.topBarHeight + rh * 1.5 - (this.offset * cSettings.rowHeight), p.settings.w - 10, p.settings.txtHeight + 10, 0, 2, 1);
			break;
		case 1:
			var listBoxWidth = scale(100);
			var listBox_button_x = listBoxWidth + scale(50);
			gr.WriteText("Status", g_font_12_bold.str, p.settings.color1, txtbox_x, cSettings.topBarHeight + rh * 4.5 - (this.offset * cSettings.rowHeight), p.settings.w - 10, p.settings.txtHeight + 10, 0, 2, 1);
			gr.WriteText("Text Alignment", g_font_12_bold.str, p.settings.color1, txtbox_x, cSettings.topBarHeight + rh * 14.5 - (this.offset * cSettings.rowHeight), p.settings.w - 10, p.settings.txtHeight + 10, 0, 2, 1);
		...
		case 2:
			...
			gr.WriteText("Row Height", g_font_12_bold.str, p.settings.color1, txtbox_x, cSettings.topBarHeight + rh * 8.75 - (this.offset * cSettings.rowHeight), p.settings.w - 10, p.settings.txtHeight + 10, 0, 2, 1);
			gr.WriteText("Cover Art Status", g_font_12_bold.str, p.settings.color1, txtbox_x, cSettings.topBarHeight + rh * 10.75 - (this.offset * cSettings.rowHeight), p.settings.w - 10, p.settings.txtHeight + 10, 0, 2, 1);
			break;
		case 3:
			gr.WriteText("Wallpaper Status", g_font_12_bold.str, p.settings.color1, txtbox_x, cSettings.topBarHeight + rh * 1.5 - (this.offset * cSettings.rowHeight), p.settings.w - 10, p.settings.txtHeight + 10, 0, 2, 1);
			gr.WriteText("Wallpaper Image", g_font_12_bold.str, p.settings.color1, txtbox_x, cSettings.topBarHeight + rh * 3.25 - (this.offset * cSettings.rowHeight), p.settings.w - 10, p.settings.txtHeight + 10, 0, 2, 1);
			gr.WriteText("Wallpaper Effects", g_font_12_bold.str, p.settings.color1, txtbox_x, cSettings.topBarHeight + rh * 5 - (this.offset * cSettings.rowHeight), p.settings.w - 10, p.settings.txtHeight + 10, 0, 2, 1);
			break;
		}
...
function oSettings() {
	...
	this.setButtons = function () {
		...
		gb.WriteText("New Column", g_font_12_bold.str, this.color2, 0, 0, rect_w, rect_h, 2, 2);
		...
		gb.DrawRectangle(0, 0, rect_w - 1, rect_h - 1, 1, this.color1);
		gb.WriteText("Delete Column", g_font_12_bold.str, this.color2, 0, 0, rect_w, rect_h, 2, 2);
		...
		gb.DrawRectangle(0, 0, rect_w - 1, rect_h - 1, 1, this.color1);
		gb.WriteText("New Pattern", g_font_12_bold.str, this.color2, 0, 0, rect_w, rect_h, 2, 2);
		...
		gb.DrawRectangle(0, 0, rect_w - 1, rect_h - 1, 1, this.color1);
		gb.WriteText("Delete Pattern", g_font_12_bold.str, this.color2, 0, 0, rect_w, rect_h, 2, 2);
	...
	this.draw = function (gr) {
		...
		// draw Panel Title
		gr.WriteText("Panel Settings", g_font_20_bold.str, this.color2, this.x + this.closebutton.w + 20, this.y + 10, this.w - 50, height(g_font_20_bold.obj), 0, 2, 1);
		...
		for (var i = 0; i < this.tabButtons.length; i++) {
			...
			if (i == this.currentPageId) {
				...
				gr.WriteText(this.pages[i].label, g_font_12_bold.str, this.color2, x, ty, this.tab_width, this.tab_height, 2, 2, 1);
			} else {
				gr.WriteText(this.pages[i].label, g_font_12_bold.str, this.color1, x, ty, this.tab_width, this.tab_height, 2, 2, 1);
			}
		}
