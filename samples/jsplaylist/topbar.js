function oTopBar() {
	...
	this.setButtons = function () {
		...
		gb.WriteText(chars.close, g_font_fluent_12.str, blendColours(g_colour_background, g_colour_text, 0.75), 0, 0, 12, 12, 2, 2);
	...
	this.draw = function (gr) {
		if (this.visible) {
			...
			gr.WriteText(this.line1, g_font_20_bold.str, g_colour_text, this.x + this.h, this.y + 2, this.w - this.h - 20, height(g_font_20_bold.obj), DWRITE_TEXT_ALIGNMENT_LEADING, DWRITE_PARAGRAPH_ALIGNMENT_CENTER, DWRITE_WORD_WRAPPING_NO_WRAP, DWRITE_TRIMMING_GRANULARITY_CHARACTER);
			gr.WriteText(this.line2, g_font_12_bold.str, setAlpha(g_colour_text, 180), this.x + this.h, this.y + 2 + height(g_font_20_bold.obj), this.w - this.h - 20, height(g_font_12_bold.obj), DWRITE_TEXT_ALIGNMENT_LEADING, DWRITE_PARAGRAPH_ALIGNMENT_CENTER, DWRITE_WORD_WRAPPING_NO_WRAP, DWRITE_TRIMMING_GRANULARITY_CHARACTER);
