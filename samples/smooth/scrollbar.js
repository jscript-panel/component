...
function oScrollbar() {
	...
	this.setButtons = function () {
		...
		gb.WriteTextSimple(chars.up, g_font_fluent_20.str, g_colour_text & 0x55ffffff, 0, 0, this.w, this.w, 2, 2);
		this.upImage_normal.ReleaseGraphics();

		this.upImage_hover = utils.CreateImage(this.w, this.w);
		gb = this.upImage_hover.GetGraphics();
		gb.WriteTextSimple(chars.up, g_font_fluent_20.str, g_colour_text & 0x99ffffff, 0, 0, this.w, this.w, 2, 2);
		this.upImage_hover.ReleaseGraphics();

		this.upImage_down = utils.CreateImage(this.w, this.w);
		gb = this.upImage_down.GetGraphics();
		gb.WriteTextSimple(chars.up, g_font_fluent_20.str, g_colour_text, 0, 0, this.w, this.w, 2, 2);
		...
		gb.WriteTextSimple(chars.down, g_font_fluent_20.str, g_colour_text & 0x55ffffff, 0, 0, this.w, this.w, 2, 2);
		...
		gb.WriteTextSimple(chars.down, g_font_fluent_20.str, g_colour_text & 0x99ffffff, 0, 0, this.w, this.w, 2, 2);
		...
		gb.WriteTextSimple(chars.down, g_font_fluent_20.str, g_colour_text, 0, 0, this.w, this.w, 2, 2);
